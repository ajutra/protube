...
public class CommentRestController {
    ...
    @GetMapping("/{videoId}")
    public Map<String, Object> getCommentsByVideoId(@PathVariable String videoId) {
        List<GetCommentCommand> comments = getAllCommentsByVideoUseCase.getAllCommentsByVideo(videoId);
